...
export default function RadarMap({
  ...
  const handleEnterCampusMode = () => {
    ...
    toast({ 
      ...
      description: 'Showing detailed campus facilities.' 
    });
  };
    ...
    <div className="relative w-full h-full">
      ...
      */}
      {nearbyCampus && inCampusMode !== nearbyCampus && (
        <div className="absolute top-6 left-1/2 -translate-x-1/2 z-[1000] pointer-events-auto animate-in slide-in-from-top-4 fade-in">
          ...
          >
            ...
            Enter {CAMPUSES[nearbyCampus as keyof typeof CAMPUSES].name}
      ...
      <MapContainer 
        ...
        ref={setMapInstance}
      >
        <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" className="dark-osm-tiles" />
